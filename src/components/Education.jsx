...
const Education = () => {
  ...
  return (
    <section className="text-white py-20 overflow-x-hidden" id="education">
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-[#50816] rounded-lg border border-primary/20 group-hover:border-primary transition-colors">
